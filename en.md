...
- was late to the party: only discovered podcasts during the pandemic
  - started with LNP and Chaoaradio and then discovered more podcasts
...
- TPs have also been appearing outside of “nerd films” for a long time
-->
...
<!-- footer: 'Do you remember the last 3 slides? 🥲' -->
...
<!-- _header: Branding -->
<!-- footer: 'No, this does _not_ stand for **T**rusted **P**latform **M**odule! 🤡' -->
...
<!-- _header: Tools -->
<!-- footer: 'Stable Linux version when? 👉🏻👈🏻🥹' -->
...
- UltraSchall perfect for people who know little about audio
  - UltraSound on MacBook Pro instead of ThinkPad 🥲
-->
